...
module "data_shares" {
  source      = "git::https://github.com/AeternaModules/azurerm_data_share.git?ref=v4.80.0"
  data_shares = local.data_shares
}

module "data_share_dataset_blob_storages" {
  source                           = "git::https://github.com/AeternaModules/azurerm_data_share_dataset_blob_storage.git?ref=v4.80.0"
